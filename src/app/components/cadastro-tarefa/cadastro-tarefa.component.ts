...
mensagem: string = '';
    ...
    formulario = new FormGroup({
      nome : new FormControl('',  [Validators.required, Validators.minLength(8), Validators.maxLength(100)]), //campo 'nome'
      ...
      descricao : new FormControl('', [Validators.required, Validators.minLength(8), Validators.maxLength(250)]) //campo 'descricao'
    });

  //função auxilizar para verificar se os campos
  //do formulário possuem algum erro de validação
  get f() {
